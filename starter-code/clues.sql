...
select name, population, region from country where region = 'Southern Europe' order by population ASC limit 100;
...
select code, name, capital, population from country where code = 'BRA';
select * from city where id = 211 limit 10;
ANSWER: Brasília
